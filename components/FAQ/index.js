...
const FAQ = ({ type }) => {
  return(
    <GridContainer>
      <Contact>
        <ContactAbout
          title={'Hey, I\'m Shovon.👋'}
          img={'/static/profile.png'}
        >
          <p>I'm a noob coder and <Randomizer/>.</p>
          ...
          (
            <>
              <Accordion label="Who are you?">
                <p>
                  <strong>Hey, I'm Shovon!</strong> I currently reside in Chittagong, where I help simplify the home remodeling experience and help build connected, IoT experiences for homeowners at <a className="link" href="https://ryanparag.com/work/masonite">Masonite</a> - a global manufacturer of doors.
                </p>
                <p>
